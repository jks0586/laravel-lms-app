...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('organisation', function (Blueprint $table) {
            ...
            $table->index('terms_and_conditions');
            $table->index('identity_requirements');
            $table->index('welcome_email');
            $table->index('new_course_email');
            $table->index('set_password_email');
            $table->index('course_complete_email');
            $table->index('invoice_address');
            $table->index('invoice_thankyou_message');
            $table->index('avetmiss_privacy_notice');
        });
    }
