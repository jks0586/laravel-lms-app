...
Route::group([
    ...
    // dahboard routes
    Route::get('dashboard/index',[DashboardController::class,'index'])->name('lms.dashboard.index');
    Route::get('dashboard/admin',[DashboardController::class,'admin'])->name('lms.dashboard.admin');
